...
public class UIInputWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(UIInput));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "UIInput", typeof(UIInput), regs, fields, typeof(UnityEngine.MonoBehaviour));
	}
	...
	{
		UIInput.current = LuaScriptMgr.GetNetObject<UIInput>(L, 3);
		return 0;
	}
	...
	{
		UIInput.selection = LuaScriptMgr.GetNetObject<UIInput>(L, 3);
		return 0;
	}
	...
	static int set_label(IntPtr L)
	{
		...
		obj.label = LuaScriptMgr.GetNetObject<UILabel>(L, 3);
		return 0;
	}
	...
	static int set_inputType(IntPtr L)
	{
		...
		obj.inputType = LuaScriptMgr.GetNetObject<UIInput.InputType>(L, 3);
		return 0;
	}
	...
	static int set_onReturnKey(IntPtr L)
	{
		...
		obj.onReturnKey = LuaScriptMgr.GetNetObject<UIInput.OnReturnKey>(L, 3);
		return 0;
	}
	...
	static int set_keyboardType(IntPtr L)
	{
		...
		obj.keyboardType = LuaScriptMgr.GetNetObject<UIInput.KeyboardType>(L, 3);
		return 0;
	}
	...
	static int set_validation(IntPtr L)
	{
		...
		obj.validation = LuaScriptMgr.GetNetObject<UIInput.Validation>(L, 3);
		return 0;
	}
	...
	static int set_onSubmit(IntPtr L)
	{
		...
		obj.onSubmit = LuaScriptMgr.GetNetObject<List<EventDelegate>>(L, 3);
		return 0;
	}
	...
	static int set_onValidate(IntPtr L)
	{
		...
		obj.onValidate = LuaScriptMgr.GetNetObject<UIInput.OnValidate>(L, 3);
		return 0;
	}
	...
	static int Validate(IntPtr L)
	{
		...
		UIInput obj = LuaScriptMgr.GetNetObject<UIInput>(L, 1);
